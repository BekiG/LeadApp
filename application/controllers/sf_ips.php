...
//application/controllers/sf_ips.php
class SFIPS extends SalesForce {
    ...
    private $from = 'leads@ecomarkusa.com';
	...
	public function prepLead($lead) {
		...
		// client specific
		$this->sfPrep['relationship_status']= $lead->relationship_status;
		...
		$this->sfPrep['motivation']     	= $lead->motivation;
