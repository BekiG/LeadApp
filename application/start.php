...
Autoloader::map(array(
	...
	'SendMail' => path('app').'controllers/sendmail.php',
	'SalesForce' => path('app').'controllers/salesforce.php',

	// Recipients
	'SFEcoMark' => path('app').'controllers/sf_ecomark.php',
    'SFIPS' => path('app').'controllers/sf_ips.php',
	'SFRealGoods' => path('app').'controllers/sf_realgoods.php',
    'SFSALT' => path('app').'controllers/sf_salt.php',
    'SFSolarCity' => path('app').'controllers/sf_solarcity.php',
    'SFSolarUniverse' => path('app').'controllers/sf_solaruniverse.php',
    'SFSunPower' => path('app').'controllers/sf_sunpower.php',
));
